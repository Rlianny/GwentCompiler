...
namespace GwentCompiler
{
    ...
    public class LexicalError(string message, CodeLocation location) : Error(message, location);
    public class ParseError(string message, CodeLocation location) : Error(message, location);
    public class SemanticError(string message, CodeLocation location) : Error(message, location);
